...
var
  mood: byte;
  descVariance: smallint;
begin
  (* Different descriptions *)
  descVariance := randomRange(1,3);
  (* Detemine hostility *)
  mood := randomRange(1, 3);
  (* Add a dog to the list of creatures *)
  ...
  begin
    ...
    intName := 'rabidDog';
    article := True;
    if (descVariance = 1) then
      description := 'a dog, foaming at the mouth'
    else if (descVariance = 2) then
      description := 'a wild-eyed dog'
    else
      description := 'a rabid dog, covered in blood';
    glyph := 'd';
    glyphColour := 'yellow';
...
begin
    ...
    begin
      ...
      begin
        if (enemyID = 0) then
          ...
          ui.displayMessage('The rabid dog slightly wounds you')
        else
          (* If an NPC is slightly wounded *)
          ui.displayMessage('The dog slightly wounds the ' + entityList[enemyID].race);
      end
      else
      ...
      begin
        if (enemyID = 0) then
          (* To the player *)
        begin
          ui.displayMessage('The rabid dog bites you, inflicting ' + IntToStr(damageAmount) + ' damage');
          (* Update health display to show damage *)
          ui.updateHealth;
        end
        else
          (* To an NPC *)
          ui.displayMessage('The dog bites the ' + entityList[enemyID].race);
      end;
    end;
  end
  else
  ...
  begin
    ...
    begin
      ...
      ui.displayMessage('The dog nips at the ' + entityList[enemyID].race + ', but misses');
  end;
end;
