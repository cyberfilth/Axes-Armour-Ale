...
var
  ...
  dfileName, Value, Gplaceholder: shortstring;
    ...
    begin
      ...
      begin
        ...
        if (island.overworldMap[r][c].Glyph = chr(6)) and (island.overworldMap[r][c].GlyphColour = 'green') then
           ...
           Gplaceholder := 'B'
        else if (island.overworldMap[r][c].Glyph = chr(5)) and (island.overworldMap[r][c].GlyphColour = 'green') then
           Gplaceholder := 'C'
           ...
           Gplaceholder := 'J'
        else if (island.overworldMap[r][c].Glyph = chr(94)) and (island.overworldMap[r][c].GlyphColour = 'brown') then
           Gplaceholder := 'K'
        else if (island.overworldMap[r][c].Glyph = ':') and (island.overworldMap[r][c].GlyphColour = 'brown') then
           Gplaceholder := 'L'
        else if (island.overworldMap[r][c].Glyph = ';') and (island.overworldMap[r][c].GlyphColour = 'brown') then
           ...
           Gplaceholder := 'N'
        else if (island.overworldMap[r][c].Glyph = '>') and (island.overworldMap[r][c].GlyphColour = 'white') then
           Gplaceholder := '>'
...
var
  ...
  Doc: TXMLDocument;
  dfileName, loadedGlyph: shortstring;
  r, c: smallint;
begin
  dfileName := (globalUtils.saveDirectory + PathDelim + 'ellanToll.dat');
  try
    ...
    begin
      ...
      begin
        ...
        loadedGlyph := UTF8Encode(Glyph.TextContent[1]);
        case loadedGlyph of
             'A':
               begin
...
begin
  ...
  try
    ...
    AddElement(datanode, 'lvlVis', BoolToStr(True));
    ...
    AddElement(datanode, 'ttlDpth', IntToStr(totalDepth));
    ...
    for i := Low(itemList) to High(itemList) do
      ...
      begin
        begin
          ...
          AddElement(DataNode, 'desc', itemList[i].itemDescription);
          ...
          AddElement(DataNode, 'd', BoolToStr(itemList[i].discovered));
        end;
      end;
    ...
    for i := 1 to entities.npcAmount do
      ...
      begin
        begin
          ...
          AddElement(DataNode, 'desc', entities.entityList[i].description);
          ...
          AddElement(DataNode, 'curHP', IntToStr(entities.entityList[i].currentHP));
          ...
          AddElement(DataNode, 'wDice',
            IntToStr(entities.entityList[i].weaponDice));
          AddElement(DataNode, 'wAdds',
          ...
          AddElement(DataNode, 'd', BoolToStr(entities.entityList[i].discovered));
          AddElement(DataNode, 'weaponEq', BoolToStr(entities.entityList[i].weaponEquipped));
          AddElement(DataNode, 'armourEq', BoolToStr(entities.entityList[i].armourEquipped));
...
begin
  ...
  try
    ...
    levelVisited := StrToBool(UTF8Encode(RootNode.FindNode('lvlVis').TextContent));
    ...
    universe.totalDepth := StrToInt( UTF8Encode(RootNode.FindNode('ttlDpth').TextContent));
    ...
    begin
      ...
      begin
        ...
        items.itemList[i].itemDescription := UTF8Encode(ItemsNode.FindNode('desc').TextContent);
        ...
        items.itemList[i].discovered := StrToBool(UTF8Encode(ItemsNode.FindNode('d').TextContent));
    ...
    begin
      ...
      begin
        ...
        entities.entityList[i].description := UTF8Encode(NPCnode.FindNode('desc').TextContent);
        ...
        entities.entityList[i].currentHP := StrToInt(UTF8Encode(NPCnode.FindNode('curHP').TextContent));
        ...
        entities.entityList[i].weaponDice := StrToInt(UTF8Encode(NPCnode.FindNode('wDice').TextContent));
        entities.entityList[i].weaponAdds := StrToInt(UTF8Encode(NPCnode.FindNode('wAdds').TextContent));
        ...
        entities.entityList[i].discovered := StrToBool(UTF8Encode(NPCnode.FindNode('d').TextContent));
        entities.entityList[i].weaponEquipped := StrToBool(UTF8Encode(NPCnode.FindNode('weaponEq').TextContent));
        entities.entityList[i].armourEquipped := StrToBool(UTF8Encode(NPCnode.FindNode('armourEq').TextContent));
        ...
        entities.entityList[i].stsFrozen := StrToBool(UTF8Encode(NPCnode.FindNode('stsF').TextContent));
        ...
        entities.entityList[i].tmrFrozen := StrToInt(UTF8Encode(NPCnode.FindNode('tmrF').TextContent));
...
begin
  try
    ...
    (* Current depth *)
    universe.currentDepth := StrToInt(UTF8Encode(RootNode.FindNode('curDepth').TextContent));
    ...
    entities.entityList[0].description := UTF8Encode(PlayerDataNode.FindNode('desc').TextContent);
    ...
    entities.entityList[0].currentHP := StrToInt(UTF8Encode(PlayerDataNode.FindNode('curHP').TextContent));
    ...
    entities.entityList[0].weaponDice := StrToInt(UTF8Encode(PlayerDataNode.FindNode('wDice').TextContent));
    entities.entityList[0].weaponAdds := StrToInt(UTF8Encode(PlayerDataNode.FindNode('wAdds').TextContent));
    ...
    entities.entityList[0].weaponEquipped := StrToBool(UTF8Encode(PlayerDataNode.FindNode('weaponEq').TextContent));
    entities.entityList[0].armourEquipped := StrToBool(UTF8Encode(PlayerDataNode.FindNode('armourEq').TextContent));
    ...
    begin
      ...
      player_inventory.inventory[i].description := UTF8Encode(InventoryNode.FindNode('desc').TextContent);
...
begin
  ...
  try
    ...
    AddElement(datanode, 'dID', IntToStr(uniqueID));
    AddElement(datanode, 'curDepth', IntToStr(currentDepth));
    AddElement(datanode, 'lvlVis', BoolToStr(True));
    ...
    AddElement(DataNode, 'desc', entities.entityList[0].description);
    ...
    AddElement(DataNode, 'curHP', IntToStr(entities.entityList[0].currentHP));
    ...
    AddElement(DataNode, 'wDice', IntToStr(entities.entityList[0].weaponDice));
    AddElement(DataNode, 'wAdds', IntToStr(entities.entityList[0].weaponAdds));
    ...
    AddElement(DataNode, 'weaponEq', BoolToStr(entities.entityList[0].weaponEquipped));
    AddElement(DataNode, 'armourEq', BoolToStr(entities.entityList[0].armourEquipped));
    ...
    begin
      ...
      AddElement(DataNode, 'desc', inventory[i].description);
