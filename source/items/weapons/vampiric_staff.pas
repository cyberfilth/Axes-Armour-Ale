...
begin
  ...
  begin
    ...
    begin
      itemName := 'Vampiric Staff';
      itemDescription := '+1D6 to attack, Zap drains HP from enemies';
    end
    else
    begin
...
begin
  ...
  begin
    ...
    if (player_stats.playerRace <> 'Dwarf') then
    begin
      ui.displayMessage('Equipped. The staff steals HP from nearby enemies [z]');
      ui.equippedWeapon := 'Vampiric staff';
    end
    else
    begin
