...
begin
  ...
  begin
    itemID := indexID;
    itemName := 'Flint dagger';
    itemDescription := 'Dagger with flint blade, adds 1D6+8 to attack';
    itemArticle := 'a';
    itemType := itmWeapon;
...
var
  info: shortstring;
begin
  info := 'You unequip the flint dagger.';
  if (equipped = False) then
    (* To equip the weapon *)
  begin
    info := 'You equip the flint dagger.';
    ...
    ui.equippedWeapon := 'Flint dagger';
